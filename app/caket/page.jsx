    ...
    <div class="container-visi-misi-1">
      <div class="visi-misi-1">
        ...
        <ol>
          ...
          <li>Mengakomodasi program dan kegiatan tepat guna dan terintegrasi berdasarkan keinginan dan kebutuhan mahasiswa TETI FT UGM.</li>
          <li>Mengutamakan kolaborasi yang mengedepankan etos kerja dan &quot;Sense of Belonging&quot; terhadap KMTETI.</li>
          <li>Mengembangkan profesionalitas untuk meningkatkan potensi dari mahasiswa TETI. Memaknai dan mengedepankan KMTETI sebagai organisasi yang bersifat kekeluargaan.</li>
        </ol>
      </div>
      <div class="foto-calon-caket"><img src="kandidat/calon1.png" alt="" /></div>
    </div>
    <div class="container-calon-2-caket">
      <div class="nama-calon">
      <span class="header-text-caket">PIJAR</span>WIDYANARA ANDHITA HERMAWAN<br />
    ...
    <div class="container-visi-misi-2">
      ...
      <div class="visi-misi-2">
        ...
        <ol>
          ...
          <li>Mengadakan kegiatan pengembangan diri dan kompetisi di antara anggota KMTETI untuk mendorong pertumbuhan pribadi yang profesional.</li>
          <li>Mendukung inisiatif proyek bersama antara mahasiswa antar angkatan untuk industri guna memberikan pengalaman dunia yang nyata kepada anggota KMTETI.</li>
          <li>Menggalang kolaborasi antarprodi di dalam Fakultas Teknik maupun fakultas lain guna memperluas wawasan dan keterampilan lintas disiplin yang dinamis.</li>
        </ol>
      </div>
    </div>
    <div class="container-calon-3-caket">
      <div class="urutan">03</div>
      <div class="nama-calon">
        BAGAS <span class="header-text-caket">PUJANG</span>KORO<br />
        <div class="jurusan">TEKNIK ELEKTRO 2022</div>
      </div>
    </div>
    <div class="container-visi-misi-3">
      <div class="visi-misi-3">
        ...
        <ol>
          ...
          <li>Mewadahi, memproses, dan melaksanakan aspirasi mahasiswa DTETI.</li>
          <li>Meningkatkan kerjasama dan membangun relasi dengan berbagai pihak baik internal maupun eksternal KMTETI.</li>
          <li>Mendorong mahasiswa KMTETI untuk selalu kreatif, adaptif, dan inovatif.</li>
        </ol>
      </div>
      <div class="foto-calon-caket"><img src="kandidat/calon3.png" width="" alt="" /></div>
    </div>
    </div>
  )
}

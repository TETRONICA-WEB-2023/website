...
const page = () => {
  return (
    <main className="text-white">
      <section id="pemilu" className="about-section">
        <div class="outer-border">
          <div class="inner-border">
            <h1 className="h-top-about">PEMILIHAN UMUM</h1>
            <h3 className="h-bottom-about">KMTETI 2023</h3>
            <p>
              Pemilihan Umum Keluarga Mahasiswa Teknik Elektro dan Teknologi
              Informasi Fakultas Teknik Universitas Gadjah Mada adalah sarana
              pelaksanaan kedaulatan mahasiswa berdasarkan Anggaran Dasar dan
              Anggaran Rumah Tangga Keluarga Mahasiswa Teknik Elektro dan
      ...
      <section id="kpu" className="about-section">
        <div class="outer-border">
          <div class="inner-border">
            <h1 className="h-top-about">KOMISI PEMILIHAN UMUM</h1>
            <h3 className="h-bottom-about">KMTETI 2023</h3>
            <p>
              ...
              pemilu berdasarkan Undang-Undang Pemilu. Pada tahun ini, KPU
              KMTETI mengusung tema TETRONICA. TETRONICA sendiri merupakan
              singkatan dari
      ...
      <section id="tugas" className="about-section">
        <div class="outer-border">
          <div class="inner-border">
            <h1 className="h-top-about">TUGAS DAN WEWENANG</h1>
            <h3 className="h-bottom-about">KPU KMTETI</h3>
            <ol>
              <li>
              ...
              <li>
                Menetapkan, mengkoordinasikan, menyelenggarakan, dan
      ...
      <section id="panitia" className="about-section">
        <div class="outer-border">
          <div class="inner-border">
            <h1 className="h-top-about">ORGANIZING COMMITTEE</h1>
            <h3 className="h-bottom-about">KPU KMTETI 2023</h3>
            <div
              id="carousel-panitia"
